      ...
      try {
        ...
        await axios
          .get(
            ...
            `${window.location.origin}/api/v1/messages/getMessages?conversationId=${conversation?._id}`,
            {
    ...
    if (!blocked) {
        ...
        if (messages.length === 0) {
          await axios
            .post(
              ...
              `${window.location.origin}/api/v1/conversations/newConversation`,
              {
                senderId: user._id,
      ...
      try {
        await axios
          ...
          .post(`${window.location.origin}/api/v1/messages/newMessage`, message)
          .then((response) => {
            console.log(response);
      ...
      try {
        await axios
          .put(
            ...
            `${window.location.origin}/api/v1/conversations/updateConversation?conversationId=${conversation?._id}`,
            {
