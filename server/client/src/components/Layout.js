      ...
      try {
        await axios
          .get(
            ...
            `${window.location.origin}/api/v1/users/myProfile?email=${user?.email}`,
            {
      ...
      try {
        await axios
          .get(
            ...
            `${window.location.origin}/api/v1/notifications/countNotifications?userId=${userContext.user?._id}`,
            {
              withCredentials: true,
            }
          )
      ...
      try {
        await axios
          .get(
            ...
            `${window.location.origin}/api/v1/conversations/getConversations?user_id=${userContext.user?._id}`,
            {
              withCredentials: true,
            }
          )
      ...
      try {
        await axios
          // .get(`http://localhost:4000/api/v1/reports/countUnresolvedReports`, {
            .get(`${window.location.origin}/api/v1/reports/countUnresolvedReports`, {
            withCredentials: true,
          })
          .then((response) => {
            console.log(response);
      ...
      try {
        axios
          .post(
            ...
            `${window.location.origin}/api/v1/users/updateAvatar?userId=${userContext.user?._id}`,
            {
              avatar: user?.picture,
            },
            {
        ...
        try {
          ...
          await axios
            .put(
              ...
              `${window.location.origin}/api/v1/conversations/updateConversation?conversationId=${data.conversation._id}`,
              {
        ...
        try {
          await axios
            .post(
              ...
              `${window.location.origin}/api/v1/notifications/newNotification`,
              {
        ...
        try {
          await axios
            .delete(
              ...
              `${window.location.origin}/api/v1/notifications/clearNotifications?userId=${userContext.user._id}`,
              {
                withCredentials: true,
              }
            )
