  ...
  const handleRemoveUser = async (e) => {
    try {
      const response = await axios.put(
        ...
        `${window.location.origin}/api/v1/users/removeUser?id=${props.report.reportedId}&user_type=${props.report.reportedUserType}`,
        {
      ...
      const response2 = await axios.put(
        ...
        `${window.location.origin}/api/v1/reports/updateResolvedStatus?id=${props.report._id}`,
        {},
        {
          withCredentials: true,
        }
